...
const Borrower_Fg_Modal = props => {
  ...
  const {boreower_fg_visible,hideBorrFigModal} = props;
...
function Individual_Loan(props) {
  ...
  const hideBorrFigModal=()=>setBorFgVisible(false)
  ...
  return (
    <>
      ...
      <RenderBottomSheet />
      <Borrower_Fg_Modal boreower_fg_visible={boreower_fg_visible} hideBorrFigModal={hideBorrFigModal} />
      <Borrower_modal
