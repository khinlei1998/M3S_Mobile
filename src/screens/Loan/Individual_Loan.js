...
function Individual_Loan(props) {
  ...
  // fg
  const [boreower_fg_visible, setBorFgVisible] = useState(false);
  ...
  const showBorFigModal = () => {

    setBorFgVisible(!boreower_fg_visible)
  ...
  return (
    <>
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <Borrower_Sign
              ...
              boreower_fg_visible={boreower_fg_visible}
              // setBorFgVisible={setBorFgVisible}
      ...
      <RenderBottomSheet />
      <Borrower_Fg_Modal boreower_fg_visible={boreower_fg_visible} hideBorrFigModal={hideBorrFigModal} timerCount={timerCount}
        show_borrower_fig={show_borrower_fig} imageSource={randomImageSource}
      />
