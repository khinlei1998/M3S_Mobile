      ...
      <Collapsible collapsed={open_business_info}>
        <View
          ...
          <View
            ...
            <Text style={{ marginLeft: 10, fontSize: 15, fontWeight: 'bold' }}>Business Period</Text>
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              {show_businessdate == 'estimated' ? (
                <Field
                  ...
                  pickerStyle={{
                    backgroundColor: 'red', width: 280, marginLeft: 10, padding: 0, height: 0,
                  }}
                />
              ...
              <Field
                ...
                component={DropDownPicker}
                pickerStyle={{
                  backgroundColor: '#FFF', width: 280, marginRight: 10, padding: 0, height: 0,
                }}
              />
            ...
            <View style={{ marginTop: 15 }}>
              <Text style={{ marginLeft: 10, fontSize: 15, fontWeight: 'bold' }}>Current Businesss Start Date</Text>
              ...
              <View
                ...
                {show_business_date == 'estimated' ? (
                  <Field
                    ...
                    component={DropDownPicker}
                    pickerStyle={{
                      backgroundColor: '#FFF', width: 280, marginLeft: 10, padding: 0, height: 0,
                    }}
                  />
                ...
                <View>
                  <Text style={{ fontSize: 15, fontWeight: 'bold', marginLeft: 10 }}>Business Situation</Text>
                  <Field
